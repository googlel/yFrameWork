...
public class ClearEditText extends EditText implements TextWatcher {
    ...
    private void init(Context context) {
        final int PADDING_RIGHT = (int) ViewUtils.dp2Px(context, 6);
        final int PADDING_TOP = (int) ViewUtils.dp2Px(context, 4);

        mClearDrawable = getCompoundDrawables()[2];
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.clear_text_icon);
        }
