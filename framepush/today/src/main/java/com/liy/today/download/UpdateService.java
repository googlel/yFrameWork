...
public class UpdateService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (!startDownload && intent != null) {
            ...
            checkMd5 = intent.getStringExtra (MD5);
            ...
            buildNotification ();
            buildBroadcast ();
            new DownloadApk (this, checkMd5).execute (downloadUrl);
        }
...
//        builder = new NotificationCompat.Builder(this);
    ...
    private static class DownloadApk extends AsyncTask<String, Integer, String> {
        ...
        public DownloadApk(UpdateService service, String checkMd5) {
        ...
        protected String doInBackground(String... params) {
            ...
            File targetFile = file.getParentFile ();
            ...
            try {
                ...
                if (response != null && response.isSuccessful ()) {
                    ...
                    while ((readSize = inputStream.read (buffer)) > 0) {
                        ...
                        publishProgress ((currentSize * 100 / total));
                    }
        ...
        protected void onPostExecute(String s) {
            ...
            UpdateService service = updateServiceWeakReference.get ();
            if (checkMd5.equals (MD5Utils.getFileMD5 (new File (s)))) {
                if (service != null) {
                    if (s != null) {
                        service.success (s);
                    } else {
