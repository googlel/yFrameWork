package com.liy.today.recyclerview;
...
import com.liy.today.recyclerview.widget.MyRefreshHeader;
...
//    private MyRefreshHeader rentalsSunHeaderView;
...
//        mHeaderView.setLastUpdateTimeRelateObject("fuck");
        rentalsSunHeaderView = new MyRefreshHeader(mContext);
//        rentalsSunHeaderView = new GIfRefreshHeader(mContext);
        rentalsSunHeaderView.setLastUpdateTimeKey(this.getClass().getName());
        setHeaderView(rentalsSunHeaderView);
        addPtrUIHandler(rentalsSunHeaderView);
    }
