...
import com.liy.today.network.HttpClient;
...
public class FrescoUtils {
    ...
    private static ImagePipelineConfig configureCaches(Context context) {
        ...
        ImagePipelineConfig config = OkHttpImagePipelineConfigFactory
                .newBuilder(context, HttpClient.getInstance(context).getOkHttpClient())
...
//                .setDownsampleEnabled (true);
    ...
    public static void setSclayType(SimpleDraweeView view, ScalingUtils.ScaleType tyle) {
        view.getHierarchy().setActualImageScaleType(tyle);
    }


    public static void setOverlayImage(SimpleDraweeView view, int resId) {
        view.getHierarchy().setOverlayImage(BaseApplication.getBaseApplication().getResources().getDrawable(resId));
    ...
    private static void updateViewSize(final SimpleDraweeView draweeView, @Nullable ImageInfo imageInfo) {
        ...
        if (imageInfo != null) {
            ...
            } else if (imageInfo.getWidth() > ViewUtils.getWidthPixels()) {//如果图片的宽度远远大于屏幕宽度 则: 不管他 他自己会充满父控件
            }
    ...
    public static void loadBitmapAndRemoveMemory(final String url, final BitmapLoadCallback listen) {
        ...
        DataSource<CloseableReference<CloseableImage>> dataSource
                =
                imagePipeline.fetchDecodedImage(imageRequest, BaseApplication.getBaseApplication());
    ...
    public static boolean isInDisk(String url) {
        ...
        return ImagePipelineFactory.getInstance().getMainBufferedDiskCache().containsSync(cacheKey);
    }
