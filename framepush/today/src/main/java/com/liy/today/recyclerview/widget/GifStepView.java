...
public class GifStepView extends View {
	...
	public GifStepView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public GifStepView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public GifStepView(Context context) {
		super(context);
		init();
	}
	...
	private void init(){
		...
		//保证两个View的宽高一致了
		endBitmap = BitmapFactory.decodeResource(getResources(), R.drawable._aaa);
	}
