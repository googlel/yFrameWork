...
public class SlideClosableRelativeLayout extends RelativeLayout {
    ...
    /**
     * Indicates that the layout is in an idle, settled state. The current rotate_page
    ...
    /**
     * Set is enable to slide
     * @param isEnableSlide isEnableSlide
     */
    public void setEnableSlide(boolean isEnableSlide) {
        mIsEnableSlide = isEnableSlide;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        if (!mIsEnableSlide || mIsUnableToDrag) {
